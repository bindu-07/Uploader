...
public class MainActivity extends AppCompatActivity {
    TextView pdf_upload,docx_upload, xlsx_upload;
    Uri imageuri = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdf_upload = findViewById(R.id.pdf);
        docx_upload = findViewById(R.id.docx);
        xlsx_upload = findViewById(R.id.xlsx);
        ...
        docx_upload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent galleryIntent = new Intent();
                galleryIntent.setAction(Intent.ACTION_GET_CONTENT);
        ...
        xlsx_upload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent galleryIntent = new Intent();
                galleryIntent.setAction(Intent.ACTION_GET_CONTENT);
                ...
                // We will be redirected to choose pdf
                galleryIntent.setType("application/xlsx");
                startActivityForResult(galleryIntent, 1);
            }
        });
    }
